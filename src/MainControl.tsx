...
const MainControl: React.FC = () => {
    ...
    const [endpoint3, setEndpoint3] = useState('5003'); // CHANGED to reflect the port number of the third endpoint
    const [endpoint4, setEndpoint4] = useState('5004'); // CHANGED to reflect the port number of the fourth endpoint
            ...
            <Stack direction="row" spacing={3}>
                <Paper elevation={3} sx={{ padding: 2, flex: 1 }}>
                    ...
                    >
                        ...
                        {/* Additional endpoints  change the names below. CHANGED */}
                        <Stack direction="row" alignItems="center">
